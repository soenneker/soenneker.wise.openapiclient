...
using System;
namespace Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing
{
    /// <summary>
    /// Builds and executes requests for operations under \simulation\spend\profiles\{profileId}\cards\{cardToken}\transactions\clearing
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ClearingRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing.ClearingRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClearingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/simulation/spend/profiles/{profileId}/cards/{cardToken}/transactions/clearing", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing.ClearingRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ClearingRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/simulation/spend/profiles/{profileId}/cards/{cardToken}/transactions/clearing", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing.ClearingRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing.ClearingRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Simulation.Spend.Profiles.Item.Cards.Item.Transactions.Clearing.ClearingRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
