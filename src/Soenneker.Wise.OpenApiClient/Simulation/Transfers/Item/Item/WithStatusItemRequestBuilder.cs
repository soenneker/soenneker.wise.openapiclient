...
using System;
namespace Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \simulation\transfers\{transferId}\{status}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithStatusItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item.WithStatusItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStatusItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/simulation/transfers/{transferId}/{status}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item.WithStatusItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStatusItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/simulation/transfers/{transferId}/{status}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Wise.OpenApiClient.Models.SimulationTransferStateChange200Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Wise.OpenApiClient.Models.SimulationTransferStateChange200Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Wise.OpenApiClient.Models.SimulationTransferStateChange200Response>(requestInfo, global::Soenneker.Wise.OpenApiClient.Models.SimulationTransferStateChange200Response.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Changes the transfer status to the specified state. The available state transitions are:- `processing` — from `incoming_payment_waiting`- `funds_converted` — from `processing`. Refer to regional guides for special regional requirements.- `outgoing_payment_sent` — from `funds_converted`- `bounced_back` — from `outgoing_payment_sent`- `funds_refunded` — from `bounced_back`.{% admonition type=&quot;info&quot; %}Important notes - Simulation is not supported for email transfers. - Fund the transfer first before calling any simulation endpoints. - Even if funding moves the transfer to a processing state, you must still call the /processing simulation endpoint. - Although the simulation request may respond immediately, processing is asynchronous - wait at least 5 seconds between simulation calls.{% /admonition %}### Sandbox refund simulation behaviour {% #sandbox-refund %}When simulating `funds_refunded`, a `transfers#refund` webhook is delivered with a simulated `refund_amount`. The amount is calculated as follows:- **SWIFT payouts:** A random fee between 5-15% is deducted from the source amount. This is non-deterministic — each simulation produces a different refund amount. This is intended for testing your partial refund handling flow.- **Non-SWIFT payouts:** The full source amount is refunded.The simulated refund amount only applies to the webhook payload. Balances and the sandbox UI will always reflect the full refund amount regardless of payout method, so the webhook `refund_amount` may differ from what is shown in balances and the sandbox UI for SWIFT transfers.  This simulation is not suitable for reconciliation testing between webhook amounts and balances.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item.WithStatusItemRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item.WithStatusItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Simulation.Transfers.Item.Item.WithStatusItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
