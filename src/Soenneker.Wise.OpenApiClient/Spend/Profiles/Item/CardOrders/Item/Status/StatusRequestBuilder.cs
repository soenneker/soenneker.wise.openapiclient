...
{
    /// <summary>
    /// Builds and executes requests for operations under \spend\profiles\{profileId}\card-orders\{cardOrderId}\status
    /// </summary>
    ...
    public partial class StatusRequestBuilder : BaseRequestBuilder
    {
        ...
        public StatusRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/spend/profiles/{profileId}/card-orders/{cardOrderId}/status", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Spend.Profiles.Item.CardOrders.Item.Status.StatusRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatusRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/spend/profiles/{profileId}/card-orders/{cardOrderId}/status", rawUrl)
        {
        }
        /// <summary>
