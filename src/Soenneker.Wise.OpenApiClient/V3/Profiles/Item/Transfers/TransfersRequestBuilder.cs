...
using Soenneker.Wise.OpenApiClient.V3.Profiles.Item.Transfers.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.Wise.OpenApiClient.V3.Profiles.Item.Transfers
{
    /// <summary>
    /// Builds and executes requests for operations under \v3\profiles\{profileId}\transfers
    /// </summary>
    ...
    public partial class TransfersRequestBuilder : BaseRequestBuilder
    {
        ...
        public TransfersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/profiles/{profileId}/transfers", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.V3.Profiles.Item.Transfers.TransfersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransfersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v3/profiles/{profileId}/transfers", rawUrl)
        {
        }
    }
}
