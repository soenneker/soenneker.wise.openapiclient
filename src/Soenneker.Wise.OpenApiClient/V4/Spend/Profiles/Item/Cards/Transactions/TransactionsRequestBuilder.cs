...
using Soenneker.Wise.OpenApiClient.V4.Spend.Profiles.Item.Cards.Transactions.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.Wise.OpenApiClient.V4.Spend.Profiles.Item.Cards.Transactions
{
    /// <summary>
    /// Builds and executes requests for operations under \v4\spend\profiles\{profileId}\cards\transactions
    /// </summary>
    ...
    public partial class TransactionsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Wise.OpenApiClient.V4.Spend.Profiles.Item.Cards.Transactions.Item.WithTransactionItemRequestBuilder this[long position]
        {
            get
            {
        ...
        public TransactionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v4/spend/profiles/{profileId}/cards/transactions", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.V4.Spend.Profiles.Item.Cards.Transactions.TransactionsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TransactionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v4/spend/profiles/{profileId}/cards/transactions", rawUrl)
        {
        }
    }
}
