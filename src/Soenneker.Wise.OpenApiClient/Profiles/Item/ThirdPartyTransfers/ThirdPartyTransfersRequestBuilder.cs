...
using Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers
{
    /// <summary>
    /// Builds and executes requests for operations under \profiles\{profileId}\third-party-transfers
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ThirdPartyTransfersRequestBuilder : BaseRequestBuilder
    {
        /// <summary>Gets an item from the Soenneker.Wise.OpenApiClient.profiles.item.thirdPartyTransfers.item collection</summary>
        ...
        public global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.Item.WithTransferItemRequestBuilder this[long position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("transferId", position);
                return new global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.Item.WithTransferItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.ThirdPartyTransfersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThirdPartyTransfersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/profiles/{profileId}/third-party-transfers", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.ThirdPartyTransfersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ThirdPartyTransfersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/profiles/{profileId}/third-party-transfers", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.ThirdPartyTransfersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.ThirdPartyTransfersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Profiles.Item.ThirdPartyTransfers.ThirdPartyTransfersRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
