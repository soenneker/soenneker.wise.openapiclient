...
using System;
namespace Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount
{
    /// <summary>
    /// Builds and executes requests for operations under \profiles\{profileId}\excess-money-account
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class ExcessMoneyAccountRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount.ExcessMoneyAccountRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExcessMoneyAccountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/profiles/{profileId}/excess-money-account", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount.ExcessMoneyAccountRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExcessMoneyAccountRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/profiles/{profileId}/excess-money-account", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount.ExcessMoneyAccountRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount.ExcessMoneyAccountRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Profiles.Item.ExcessMoneyAccount.ExcessMoneyAccountRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
