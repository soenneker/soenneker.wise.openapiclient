...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class QuoteCreate : IAdditionalDataHolder, IParsable
...
#nullable enable
        public global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_paymentMetadata? PaymentMetadata { get; set; }
#nullable restore
#else
        public global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_paymentMetadata PaymentMetadata { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_pricingConfiguration? PricingConfiguration { get; set; }
#nullable restore
#else
        public global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_pricingConfiguration PricingConfiguration { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate"/> and sets the default values.
        /// </summary>
        public QuoteCreate()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "paymentMetadata", n => { PaymentMetadata = n.GetObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_paymentMetadata>(global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_paymentMetadata.CreateFromDiscriminatorValue); } },
                { "preferredPayIn", n => { PreferredPayIn = n.GetStringValue(); } },
                { "pricingConfiguration", n => { PricingConfiguration = n.GetObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_pricingConfiguration>(global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_pricingConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_paymentMetadata>("paymentMetadata", PaymentMetadata);
            writer.WriteStringValue("payOut", PayOut);
            writer.WriteStringValue("preferredPayIn", PreferredPayIn);
            writer.WriteObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreate_pricingConfiguration>("pricingConfiguration", PricingConfiguration);
