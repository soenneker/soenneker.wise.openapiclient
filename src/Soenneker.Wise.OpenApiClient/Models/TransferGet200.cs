...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class TransferGet200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.Wise.OpenApiClient.Models.TransferGet200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.Wise.OpenApiClient.Models.TransferGet200();
