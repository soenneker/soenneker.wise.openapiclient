...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class QuoteCreateRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequest"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "paymentMetadata", n => { PaymentMetadata = n.GetObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPaymentMetadata>(global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPaymentMetadata.CreateFromDiscriminatorValue); } },
                { "preferredPayIn", n => { PreferredPayIn = n.GetStringValue(); } },
                { "pricingConfiguration", n => { PricingConfiguration = n.GetObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPricingConfiguration>(global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPricingConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPaymentMetadata>("paymentMetadata", PaymentMetadata);
            writer.WriteStringValue("payOut", PayOut);
            writer.WriteStringValue("preferredPayIn", PreferredPayIn);
            writer.WriteObjectValue<global::Soenneker.Wise.OpenApiClient.Models.QuoteCreateRequestPricingConfiguration>("pricingConfiguration", PricingConfiguration);
