...
{
    /// <summary>
    /// Returned when the operation conflicts with the current state of the case.**Common causes:**- Submitting a message to a case in a final state (`RESOLVED` or `FAILED`)- Submitting FREEFORM or FILE_SUBMISSION when no Wise Agent is assigned to the case- Submitting a structured response when the case was not generated by Wise
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class Error409Conflict : ApiException, IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Models.Error409Conflict"/> and sets the default values.
        /// </summary>
        public Error409Conflict()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Models.Error409Conflict"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Wise.OpenApiClient.Models.Error409Conflict CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Wise.OpenApiClient.Models.Error409Conflict();
        }
        /// <summary>
