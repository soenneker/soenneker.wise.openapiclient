...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class TransferCancel200 : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        public static global::Soenneker.Wise.OpenApiClient.Models.TransferCancel200 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("type")?.GetStringValue();
            var result = new global::Soenneker.Wise.OpenApiClient.Models.TransferCancel200();
