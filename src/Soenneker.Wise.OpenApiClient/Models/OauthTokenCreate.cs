...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class OauthTokenCreate : IComposedTypeWrapper, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Models.OauthTokenCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Wise.OpenApiClient.Models.OauthTokenCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("grant_type")?.GetStringValue();
            var result = new global::Soenneker.Wise.OpenApiClient.Models.OauthTokenCreate();
