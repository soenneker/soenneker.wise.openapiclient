...
namespace Soenneker.Wise.OpenApiClient.Models
{
    ...
    public partial class SpendLimitsCardHolderUpdateRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The limits to set, per aggregation window. At least one of `daily` or `monthly` must be provided.</summary>
...
#nullable restore
        ...
        /// </summary>
        public SpendLimitsCardHolderUpdateRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Models.SpendLimitsCardHolderUpdateRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Wise.OpenApiClient.Models.SpendLimitsCardHolderUpdateRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Wise.OpenApiClient.Models.SpendLimitsCardHolderUpdateRequest();
        }
        /// <summary>
