...
using System;
namespace Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe
{
    /// <summary>
    /// Builds and executes requests for operations under \auth\jose\playground\jwsjwe
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class JwsjweRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe.JwsjweRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public JwsjweRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/jose/playground/jwsjwe", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe.JwsjweRequestBuilder"/> and sets the default values.
        ...
        /// <exception cref="global::Soenneker.Wise.OpenApiClient.Models.JosePlaygroundJwsJweGet500Response">When receiving a 500 status code</exception>
...
#nullable restore
        ...
        public async Task<string> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "500", global::Soenneker.Wise.OpenApiClient.Models.JosePlaygroundJwsJweGet500Response.CreateFromDiscriminatorValue },
            };
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Wise.OpenApiClient.Models.Value429ResponseContent">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Wise.OpenApiClient.Models.JosePlaygroundJwsJwePost500Response">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<string> PostAsync(string body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "429", global::Soenneker.Wise.OpenApiClient.Models.Value429ResponseContent.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.Wise.OpenApiClient.Models.JosePlaygroundJwsJwePost500Response.CreateFromDiscriminatorValue },
            };
            return await RequestAdapter.SendPrimitiveAsync<string>(requestInfo, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe.JwsjweRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe.JwsjweRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Auth.Jose.Playground.Jwsjwe.JwsjweRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
