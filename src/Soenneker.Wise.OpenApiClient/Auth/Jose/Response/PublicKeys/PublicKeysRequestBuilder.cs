...
using System;
namespace Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys
{
    /// <summary>
    /// Builds and executes requests for operations under \auth\jose\response\public-keys
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PublicKeysRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PublicKeysRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/jose/response/public-keys?algorithm={algorithm}&scope={scope}{&version*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PublicKeysRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/jose/response/public-keys?algorithm={algorithm}&scope={scope}{&version*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Wise.OpenApiClient.Models.JoseResponsePublicKeysGet200Response?> GetAsync(Action<RequestConfiguration<global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder.PublicKeysRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Wise.OpenApiClient.Models.JoseResponsePublicKeysGet200Response> GetAsync(Action<RequestConfiguration<global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder.PublicKeysRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder.PublicKeysRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder.PublicKeysRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wise.OpenApiClient.Auth.Jose.Response.PublicKeys.PublicKeysRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a public key issued by Wise.Depending on the scope requested, the key will be used for verifying HTTP responses signed by Wise or for for encrypting the payload prior to sending it to Wise.For both signature verification and payload encryption, the process involves storing this public key after retrieval. In both cases, the stored public key should be used without calling this endpoint.If verification of the signed request fails or Wise is unable to decrypt your request payload, call this API to issue a fresh key from Wise and reattempt the operation again.{% admonition type=&quot;warning&quot; %}  This endpoint requires a client credentials token, not a user level access token. Make sure you use your client details to fetch a valid [client credentials token](/api-reference/oauth-token/oauthtokencreate) before performing this call.{% /admonition %}
        /// </summary>
