...
namespace Soenneker.Wise.OpenApiClient.V1.OneTimeToken.Status
{
    ...
    public partial class StatusRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Retrieve necessary information to clear a OTT.**Note:** `GET /v1/identity/one-time-token/status` will be deprecated soon. Please use `/v1/one-time-token/status` instead.
        /// </summary>
