...
using Soenneker.Wise.OpenApiClient.V5.Profiles.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System;
namespace Soenneker.Wise.OpenApiClient.V5.Profiles
{
    /// <summary>
    /// Builds and executes requests for operations under \v5\profiles
    /// </summary>
    ...
    public partial class ProfilesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Wise.OpenApiClient.V5.Profiles.Item.WithProfileItemRequestBuilder this[long position]
        {
            get
            {
        ...
        public ProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v5/profiles", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wise.OpenApiClient.V5.Profiles.ProfilesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProfilesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v5/profiles", rawUrl)
        {
        }
    }
}
